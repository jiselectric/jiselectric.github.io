...
<center>
    <img src="_img/gradient/graph.png" alt="graph of equation" title="Optional title" width="400">
</center>
...
<center>
    <img src="_img/gradient/network.png" alt="graph of equation" title="Optional title">
</center>
...
<center>
    <img src="_img/gradient/network_grad.png" alt="graph of equation" title="Optional title">
</center>
...
Now, we will see how we can **increase** the output $L$ by changing **nudging** the variables by their gradients. 
...
Key Observations
- Adding $a$ by `a.grad` increases $a$ and increases $L$.
- Adding $b$ by `b.grad` decreases $b$ and increases $L$.
